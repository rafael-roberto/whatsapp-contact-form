...
var alignment = 'left'; // left para esquerda ou right para a direita da tela
var phone = '5541988006758' // ddi+ddd+número, sem usar hífen ou parenteses, apenas os números 
var msg = 'Olá! Tenho interesse no seu produto.' // mensagem pré escrita no whatsapp do usuário
var balloon = 'Orçamento e Prazo? Pergunte aqui.'; // frase exibida no balão de call-to-action
var balloonHover;

var e = document.createElement('div');
htmldata = '<whatsapp-tag>'+
                '<a class="whatsapp-button" id="whatsapp-button" href="javascript:void(0);" onclick="whatsappLink()">'+
                ...
                '<div id="whatsapp-contact-modal" class="whatsapp-contact-modal">'+
                    '<div class="whatsapp-contact-modal-content '+alignment+'">'+
                        ...
                        '<div class="whatsapp-contact-modal-body">'+
                            '<form action="mail.php" method="POST" target="_blank" id="whatsapp-contact-form">'+
